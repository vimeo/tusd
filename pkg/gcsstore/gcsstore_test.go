...
import (
	...
	"github.com/vimeo/tusd/pkg/gcsstore"
	"github.com/vimeo/tusd/pkg/handler"
)

// go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/vimeo/tusd/pkg/gcsstore GCSReader,GCSAPI
